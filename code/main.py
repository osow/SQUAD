...
tf.app.flags.DEFINE_integer("eval_every", 300, "How many iterations to do per calculating loss/f1/em on dev set. Warning: this is fairly time-consuming so don't do it too often.")
...
def main(unused_argv):
    ...
    if FLAGS.mode == "train":
        ...
        with tf.Session(config=config) as sess:
            ...
            _, _ = qa_model.check_f1_em(sess, dev_context_path, dev_qn_path, dev_ans_path, "dev", FLAGS.experiment_name, num_samples=10, print_to_screen=True)
